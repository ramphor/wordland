    ...
    public function setupDatabase()
    {
        ...
        $tables = array(
            'wordland_properties' => '`ID` BIGINT NOT NULL AUTO_INCREMENT,
                ...
                `price` DECIMAL(20, 2) NULL DEFAULT 0,
                `unit_price` DECIMAL(10, 2) NULL DEFAULT 0,
                `acreage` FLOAT(4) NULL DEFAULT 0,
                `front_width` FLOAT(5) NULL DEFAULT 0,
                `road_width` FLOAT(5) NULL DEFAULT 0,
                `bedrooms` TINYINT(5) NULL DEFAULT 0,
                `bathrooms` TINYINT(5) NULL DEFAULT 0,
            ...
            'wordland_agents' => '`wordland_agent_id` BIGINT NOT NULL AUTO_INCREMENT,
                ...
                `area_level_1` BIGINT NOT NULL DEFAULT 0,
                `area_level_2` BIGINT NOT NULL DEFAULT 0,
                `area_level_3` BIGINT NULL DEFAULT 0,
                `area_level_4` BIGINT NULL DEFAULT 0,
            ...
            'wordland_message_references' => '`ID` BIGINT NOT NULL AUTO_INCREMENT,
                ...
                `attachment_property_id` BIGINT NOT NULL DEFAULT 0,
                `created_at` TIMESTAMP NOT NULL,
                PRIMARY KEY (`ID`)',
